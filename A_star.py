...
class A_star:
    def __init__(self,obs,robot,cart,start,goal,left_wheel_vel=None,right_wheel_vel=None):
        self.obs=obs
        self.robot=robot
        self.cart=cart
        self.start=start
    ...
    def generate_path(self):
        ...
        node=Node(self.start[0],self.start[1],self.start[2],self.start[3],self.left_wheel_vel,self.right_wheel_vel,[(self.start[0],self.start[1],self.start[2],self.start[3],self.left_wheel_vel,self.right_wheel_vel)],0,h,h)
